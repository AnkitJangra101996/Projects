...
import { changeTheme } from "../features/ecommerceSlice";

const Header = () => {
  const dispatch = useDispatch();
  const { theme, cart } = useSelector((state) => state.ecommerce);

  useEffect(() => {
    document.documentElement.setAttribute(
      "data-theme",
      localStorage.getItem("redux-ecomm-theme") || "light"
    );
  }, [theme]);
        ...
        <div className="flex-none">
          ...
          <div className="dropdown dropdown-center">
            ...
            <ul
              ...
              onClick={({ target }) =>
                dispatch(changeTheme(target.textContent))
              }
            >
              <li>
                <a>light</a>
